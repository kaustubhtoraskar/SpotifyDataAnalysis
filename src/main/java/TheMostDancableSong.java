...
public class TheMostDancableSong extends Configured implements Tool {
    ...
    public static class MapClass
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                Double loudness = Double.parseDouble(line[3]);

                TopKMap.put(new Double(loudness), new Text(line[1]));
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "TheMostDancableSong");
        job.setJarByClass(TheMostDancableSong.class);

        Path in = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\input\\featuresdf.csv");
        Path out = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\MostDancableSong");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TheMostDancableSong(), args);
