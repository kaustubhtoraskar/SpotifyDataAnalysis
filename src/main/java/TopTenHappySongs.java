...
public class TopTenHappySongs extends Configured implements Tool {
    ...
    public static class MapClass
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                Double e = Double.parseDouble(line[12]);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "TopTenHappySongs");
        job.setJarByClass(TopTenHappySongs.class);

        Path in = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\input\\featuresdf.csv");
        Path out = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\topTenHappySongs");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TopTenHappySongs(), args);
