...
public class TheMostLoudSong extends Configured implements Tool {
    ...
    public static class MapClass
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                Double loudness = Double.parseDouble(line[6]);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "TheMostLoudSong");
        job.setJarByClass(TheMostLoudSong.class);

        Path in = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\input\\featuresdf.csv");
        Path out = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\MostLoudSong");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TheMostLoudSong(), args);
