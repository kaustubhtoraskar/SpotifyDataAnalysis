...
public class TopTenSadSongs extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "TopTenSadSongs");
        job.setJarByClass(TopTenSadSongs.class);

        Path in = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\input\\featuresdf.csv");
        Path out = new Path("C:\\Users\\kaustubh\\IdeaProjects\\bdaise\\TopTenSadSongs");
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TopTenSadSongs(), args);
